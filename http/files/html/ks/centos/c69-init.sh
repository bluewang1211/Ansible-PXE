...
# install pkgs
yum install -y ansible htop ncdu ibmonitor smem iftop telegraf zlib-devel perl-devel asciidoc xmlto docbook2X make tcl build-essential tk gettext perl-devel perl-CPAN
yum clean all

chkconfig telegraf off
